...
void Game::start() {
    ...
    //--------------Choose 3 monster--------
    while (player1Team.size()<3)
    {
        std::cout << "Choose " << 3- player1Team.size() << " monsters for your team:"<< std::endl;
        ...
        // std::cin >> choosen;
        // int index=0;
        // for(nameDisplay choose : leftMonster){
        //     if(choosen == "_Choosen_"){
        //         std::cout<< " This Monster is choosen"<< std::endl;
        //     }
        //     else if (choosen == choose.name)
        //     {   
        //         //----------assign Monster to plaer's team
        //         for (Monster a : allMonsters){
        //             if( choosen == a.getName()){
        //                 player1Team.push_back(a);
        //             }
        //         }
        //         //---------change name to choosen on display;
        //         for(nameDisplay choose: leftMonster){
        //             leftMonster[index].name ="_Choosen_";
        //         }
        //     }
        //     index++;
        // }
    ...
    std::cout<<"Player 1 choosen : ";
    for(Monster a : player1Team){
        std::cout<< a.getName()<< " " ;
    }
    ...
    //--------------Choose 3 monster--------
    while (player2Team.size()<3)
    {
        std::cout<< std::endl;
        std::cout << "Choose " << 3- player2Team.size() << " monsters for your team:"<< std::endl;
        for (int i = 0; i < leftMonster.size(); i++) {
            std::cout << i+1 << ". " << leftMonster[i].name << " (" << leftMonster[i].type << ")"<<std::endl;
        } 
        int choosen;
    ...
    std::cout<<"Player 2 choosen : ";
    for(Monster a : player2Team){
        std::cout<< a.getName()<< " " ;
    }
...
void Game::checkWin() {
    //----------check if every monsters is alive
